...
async def start(event):
  await event.reply(
    "__**I'm MentionAll Bot**, I will help you to mention near about all members in your group and channel 👻\nClick **/help** for more information__\n\n Follow [Sanatani Synax](https://www.instagram.com/sanatanisynax?igsh=YzljYTk1ODg3Zg==) on Instagram",
    link_preview=False,
    buttons=(
      [
        Button.url('🦋 Support 🦋', 'https://t.me/synaxchatgroup'),
        Button.url('🦋 Update 🦋', 'https://t.me/synaxnetwork')
      ]
    )
  )
